    ...
    return (
      <div style={{ padding: '20px', background: '#fee', border: '1px solid #fcc', borderRadius: '8px' }}>
        ...
        <ul>
          ...
          <li>Verify remoteEntry.js is accessible: <a href="http://localhost:3003/remoteEntry.js" target="_blank" rel="noopener noreferrer">remoteEntry.js</a></li>
          <li>Try opening <a href="http://localhost:3003" target="_blank" rel="noopener noreferrer">http://localhost:3003</a> directly</li>
        </ul>
        <div style={{ marginTop: '15px', padding: '10px', background: '#fff3cd', borderRadius: '5px' }}>
          <strong>💡 Module Federation Status:</strong>
          <p style={{ margin: '5px 0', fontSize: '14px' }}>
            Remote URL: http://localhost:3003/remoteEntry.js<br/>
            Exposed Module: angularRemote/AppElement<br/>
    ...
    <div>
      ...
      {isElementDefined && (
        <div ref={containerRef}>
          ...
          <angular-app-element></angular-app-element>
        </div>
      )}
    </div>
  );
